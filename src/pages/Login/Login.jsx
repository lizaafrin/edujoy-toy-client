    ...
    <div className="container mx-auto px-2 lg:px-0">
      ...
      >
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div>
            <Link className="underline text-fuchsia-500">Forgot Password?</Link>
          </div>
        </div>
        ...
        <div className="text-center">
          <button
            type="submit"
            className="bg-fuchsia-500 focus:outline-none font-medium rounded-lg text-sm w-full block py-2.5"
          >
            Login
          </button>
          <div className="mt-4">
            <p>
              ...
              <Link to="/register" className="underline ml-2 text-fuchsia-500">
                Create an account
              </Link>
            </p>
          </div>
